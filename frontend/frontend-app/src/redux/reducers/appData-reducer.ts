...
let initialState = {
    testPart: {
        sectionData: [{
            ...
            sectionBody: "В текущем разделе необходимо ответить на тестовые вопросы, которые связаны с растоновкой контрольных точек" +
                ", обозначением различных показателей и расположением элементов при проведении измерений.",
            sectionRef: "/testing/test"
        },{
            sectionTitle: "Раздел 3. Проведение измерений и расчет коэффициентов звукоизоляции (виброизоляции)",
